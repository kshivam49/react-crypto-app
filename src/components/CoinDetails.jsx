    ...
    <Container maxW={'container.md'}>
      ...
      {loading?<Loader /> :(
          ...
          <VStack spacing={'4'} p={'16'} alignItems={'flex-start'}>
            ...
            <CustomBar coin={coin} high={`${currencySymbol}${coin.market_data.high_24h[currency]}`} low={`${currencySymbol}${coin.market_data.low_24h[currency]}`}/>
...
const CustomBar=({high,low,coin})=>(
  <VStack w={'full'}>
    <Progress value={50} colorScheme={coin.market_data.price_change_percentage_24h >0 ?'green':'red'} w={'full'}/>
